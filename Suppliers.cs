...
namespace Varsity_Phamarcy
{
    public partial class Suppliers : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Supplier_Order_Item' table. You can move, or remove it, as needed.
            this.supplier_Order_ItemTableAdapter.Fill(this.varsityPharmacyDataSet3.Supplier_Order_Item);
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Products' table. You can move, or remove it, as needed.
            this.productsTableAdapter.Fill(this.varsityPharmacyDataSet3.Products);
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Supplier' table. You can move, or remove it, as needed.
            this.supplierTableAdapter1.Fill(this.varsityPharmacyDataSet3.Supplier);
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if ( Phone.Length == 12)
                {
                    ...
                    if ( count5 == 1)
                    {
                        ...
                        try
                        {
                            this.supplierTableAdapter1.InsertQuery(NameS.Text, Email.Text, this.Phone.Text, Status);
                            this.supplierTableAdapter1.Fill(this.varsityPharmacyDataSet3.Supplier);
                        }
                        catch
                        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if ( Phone.Length == 12)
                {
                    ...
                    if ( count5 == 1)
                    {
                        ...
                        try
                        {
                            this.supplierTableAdapter1.UpdateQuery(NameS.Text, Email.Text, this.Phone.Text, Status, int.Parse(suppID.Text), int.Parse(suppID.Text));
                            this.supplierTableAdapter1.Fill(this.varsityPharmacyDataSet3.Supplier);
        ...
        private void textBox12_TextChanged_2(object sender, EventArgs e)
        {
            try
            {
                ...
                this.productsTableAdapter.FillBy(this.varsityPharmacyDataSet3.Products, Name);
            }
            catch
            {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                this.supplier_Order_ItemTableAdapter.FillBy(this.varsityPharmacyDataSet3.Supplier_Order_Item, Name);
        ...
        private void searchBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                this.supplierTableAdapter1.FillBy(this.varsityPharmacyDataSet3.Supplier, Name);
            }
            catch
            {
