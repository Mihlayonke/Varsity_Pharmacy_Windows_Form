    ...
    public partial class Customer : Form
    {
        ...
        private void Customer_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.customersTableAdapter1.Fill(this.varsityPharmacyDataSet3.Customers);
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (ID.Length == 13 || Phone.Length == 10)
                {
                    ...
                    if (count0 == 1 && (count1 == 1 || count2 == 1 || count3 == 1 || count4 == 1) && count5 == 1)
                    {
                        ...
                        customersTableAdapter1.InsertQuery(Name.Text, Surname.Text, Email.Text, Identity.Text, Age, this.Phone.Text, Gend.Text, Convert.ToInt16(AidNumber.Text), Number.Text, Status, AidName.Text);
                        customersTableAdapter1.Fill(this.varsityPharmacyDataSet3.Customers);
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (ID.Length == 13 || Phone.Length == 10)
                {
                    ...
                    if (count0 == 1 && (count1 == 1 || count2 == 1 || count3 == 1 || count4 == 1) && count5 == 1)
                    {
                        ...
                        customersTableAdapter1.UpdateQuery(Name.Text, Surname.Text, Email.Text, Identity.Text, int.Parse(Number.Text), this.Phone.Text, Gend.Text.ToString(), int.Parse(AidNumber.Text), Number.Text, Status, AidName.Text, int.Parse(customerID.Text), int.Parse(customerID.Text));
                        customersTableAdapter1.Fill(this.varsityPharmacyDataSet3.Customers);
        ...
        private void dataGridView1_CellContentClick_2(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                AidNumber.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();

                AidName.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
        ...
        private void textBox11_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                this.customersTableAdapter1.FillBy(this.varsityPharmacyDataSet3.Customers, custName);
            }
            catch
            {
