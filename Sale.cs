...
namespace Varsity_Phamarcy
{
    public partial class Sale : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Sale_Item2' table. You can move, or remove it, as needed.
            this.sale_Item2TableAdapter.Fill(this.varsityPharmacyDataSet3.Sale_Item2);
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Sale_item' table. You can move, or remove it, as needed.
            this.sale_itemTableAdapter.Fill(this.varsityPharmacyDataSet3.Sale_item);
            ...
            this.customersTableAdapter.Fill(this.varsityPharmacyDataSet3.Customers);
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Sale_Item2' table. You can move, or remove it, as needed.
            this.sale_Item2TableAdapter.Fill(this.varsityPharmacyDataSet3.Sale_Item2);
        ...
        private void dataGridView2_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (Q <= 0){
                ...
                productsTableAdapter.Fill(this.varsityPharmacyDataSet3.Products);
        ...
        private void search_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                this.productsTableAdapter.FillBy(this.varsityPharmacyDataSet3.Products, prodName);
            }
            catch
            {
        ...
        private void textBox4_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.customersTableAdapter.FillBy(this.varsityPharmacyDataSet3.Customers, custName);
