...
namespace Varsity_Phamarcy
{
    public partial class ManageUsers : Form
    {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (ID.Length == 13 && Phone.Length == 12)
                {
                    ...
                    if (count0 == 1 && (count1 == 1 || count2 == 1 || count3 == 1 || count4 == 1) && count5 == 1)
                    {
                        try
                        {
                            this.staffTableAdapter1.UpdateQuery(staffName.Text, comboBox1.SelectedItem.ToString(), staffPhone.Text, staffEmail.Text, staffID.Text, staffPassword.Text, Status, Int32.Parse(textBox1.Text), Int32.Parse(textBox1.Text));
                            this.staffTableAdapter1.Fill(this.varsityPharmacyDataSet3.Staff);
                            staffName.Clear();
                            staffID.Clear();
                            staffPassword.Clear();
                            staffPhone.Clear();
        ...
        {
            // TODO: This line of code loads data into the 'varsityPharmacyDataSet3.Staff' table. You can move, or remove it, as needed.
            this.staffTableAdapter1.Fill(this.varsityPharmacyDataSet3.Staff);
        ...
        private void button1_Click(object sender, EventArgs e){
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (ID.Length == 13 && Phone.Length == 12)
                {
                    ...
                    if (count0 == 1 && (count1 == 1 || count2 == 1 || count3 == 1 || count4 == 1) && count5 == 1)
                    {
                        this.staffTableAdapter1.InsertQuery(staffName.Text, comboBox1.SelectedItem.ToString(), staffPhone.Text, staffEmail.Text, staffID.Text, staffPassword.Text, Status);
                        this.staffTableAdapter1.Fill(this.varsityPharmacyDataSet3.Staff);
                        staffName.Clear();
                        staffID.Clear();
                        staffPassword.Clear();
        ...
        private void searchBox_TextChanged(object sender, EventArgs e)
        {
            ...
            this.staffTableAdapter1.FillBy(this.varsityPharmacyDataSet3.Staff, name);
